  ...
  <div class="modal-dialog" style="width: 1000px;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Doothan List</h4>
      </div>
      <div class="modal-body">
        	
      </div>
      <div class="modal-footer">
      	<button class="btn btn-primary" type="submit" id="notify_doothan" name="submit" onClick="Notify_doothan();" style="display:none;">Notify Doothan</button>
...
<?php
        ...
        $pageSizeDropDown = CHtml::dropDownList(
                        ...
                        'id' => 'pageSize',
                        'onChange'=>'ChangePagecount(this,"Request","index","")',
               )
        );
?>
<div class="table-toolbar">
            <div class="page-size-wrap" style="width:100%">
                ...
                <div class="results-perpage" style="float: right;color:#868686;">
                	<div style="margin-right: 20%;color:red;display:none;" id="display_it">
                		<span id="header_msg">Unregistred users :</span>
  						<ul style="margin-top: 20px;" id="li_content">
  							
  						</ul>
  					</div>
                   <label id="time_showing_space" style="font-size: 11px;font-weight: normal;float: right;">( Refreshed now )</label>
                </div>
...
<script type="text/javascript">
    ...
    function Find_doothan(param){
        $('#notify_doothan').css({'display':'none'});
    	var id = $(param).attr('id');
    	...
    	$.ajax({
        	...
        	dataType:'html',
        	data:{'id':id},
        	url:'<?php echo Yii::app()->createAbsoluteUrl("request/LoadModelContent"); ?>',
        	success:function(response){
        		$('.modal-body').html(response);
        	},error: function(jqXHR, textStatus, errorThrown) {
        		$('.modal-body').html("Error while loading doothan list");
            }
        });

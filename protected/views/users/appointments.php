    ...
    'columns' => array(
      ...
      'htmlOptions' => array('style' => 'width: 10%'),
       ...
       array(
        ...
        array(
            'header' => 'type',
            'value' => array($model, 'getBookingType'),
            'htmlOptions' => array('style' => 'width: 10%;text-align:center'),
            'filter' => CHtml::activeDropDownList($model, 'type', CHtml::ListData(Helper::bookingType(), 'id', 'name'), array('prompt' => 'select all')),
       ...
       array(
        'name'  => 'id',
        'header'=>'',
        'value' => array($model, 'assignTherapistLink'),
        //'value' => 'CHtml::link("assign therapist","",array("class" => "btn btn-success btn-xs ", "title" => "","data-toggle"=>"modal" ,"data-target"=>"#myModal","data-book_id"=>$data->id))',
        'type'  => 'raw',
        'filter'=>''
    ),

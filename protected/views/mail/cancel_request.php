...
<title>Doothan :: Cancel Request</title>
...
<td style="background-color:#525252; background-image:url(/mail_images/welcome.jpg); background-repeat:no-repeat !important; padding:60px 10px; ">
    ...
    <a href="http://18.216.127.175/administrator" style="color: #FFF; text-decoration: none;"><img src="http://18.216.127.175/vendor/dist/img/logo.png" alt="Doothan"></img></a>
<h1 style="color:#CCC; padding:0; margin:25px 0 0 0; font-weight:normal;">Doothan order has been cancelled</h1>
...
<p style="text-align:left;"><h2 style="text-align:left;">Order has been cancelled</h1></p>
<p style="text-align:left;">
    Your Order <b><?php echo $order_code;?></b> has been cancelled..<br/><br/>   
</p>

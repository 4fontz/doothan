...
<title>Doothan :: Change Status</title>
...
<h1 style="color:#CCC; padding:0; margin:25px 0 0 0; font-weight:normal;">Doothan Acccount Status Changed</h1>
...
<p style="text-align:left;">Hi <?php echo $name ?>,</p>
    ...
    <p style="text-align:left;"><h2 style="text-align:left;">Doothan Account Status Changed</h1>
    
    </p>

<p style="text-align:left;">
    Your Doothan account status has been changed to <b><?php echo $status_text;?></b><br/><br/>

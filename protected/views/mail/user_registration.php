...
<title>Doothan :: User Registration</title>
...
<h1 style="color:#CCC; padding:0; margin:25px 0 0 0; font-weight:normal;">User Registration</h1>
...
<p style="text-align:left;">Hi <?php echo $name ?>,</p>
    ...
    <p style="text-align:left;"><h2 style="text-align:left;">Doothan User Registration</h1>
    
    </p>

<p style="text-align:left;">
<?php if(isset($type) && $type=="requester"){?>
   ThankYou  for Registering as a Requester. We hope our service can make support for your  pickups/deliveries
<?php }else if(isset($type) && $type=="doothan"){?>
    ThankYou  for Registering as a Doothan. You can request service and at the same time  you will get payment for picking up and delivering on your way to work,home etc
<?php }else{?>
    ThankYou  for Registering as a Dropbox. You can request service and at the same time  you will get payment for storing  and delivering items to the customer
<?php }?>    
<br />
<br />
...
<table border="0" cellpadding="0" cellspacing="0" valign="top" style="text-align:center; max-width:600px; width:100%;">
    <tr>

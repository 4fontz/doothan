...
<title>Doothan :: Notify User</title>
...
<h1 style="color:#CCC; padding:0; margin:25px 0 0 0; font-weight:normal;">Notify User</h1>
...
<p style="text-align:left;">Hi <?php echo $name ?>,</p>
    ...
    <p style="text-align:left;"><h2 style="text-align:left;">Notify user</h1>

...
<td style="background-color:#525252; background-image:url(/mail_images/welcome.jpg); background-repeat:no-repeat !important; padding:60px 10px; ">
    ...
    <a href="http://18.216.127.175" style="color: #FFF; text-decoration: none;"><img src="http://18.216.127.175/vendor/dist/img/logo.png" alt="Doothan"></img></a>
<h1 style="color:#CCC; padding:0; margin:25px 0 0 0; font-weight:normal;">Welcome To Doothan</h1>
...
<p style="text-align:left;">Hi <?php echo $name ?>,</p>
    ...
    <p style="text-align:left;"><h2 style="text-align:left;">Welcome To Doothan</h1>

...
return array(
    ...
    'components' => array(
        ...
        'Smtpmail' => array(
            ...
            'Host' => "smtp.gmail.com",
            'Username' => 'cto@webvendere.com',
            'Password' => 'ctowebvendere',
            'Mailer' => 'smtp',
            'Port' => 587,
            'SMTPAuth' => true,
        )
    ...
    'params' => array(
        ...
        'awsKey' => 'AKIAISIM73HB4EQGEIIA',
        'awsSecret' => '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',
        'awsRegion' => 'us-west-2',
        'profileImageBucket' => 'doodhan-dev/doothan-user-profile',
        'profileImageBucketUrl' => 'https://s3-us-west-2.amazonaws.com/doodhan-dev/doothan-user-profile/',
        'adharImageBucket' => 'doodhan-dev/Adhar',
        'adharImageBucketUrl' => 'https://s3-us-west-2.amazonaws.com/doodhan-dev/Adhar/',
        'photoImageBucket' => 'doodhan-dev/Photos',
        'photoImageBucketUrl' => 'https://s3-us-west-2.amazonaws.com/doodhan-dev/Photos/',
        'requestImageBucket' => 'doodhan-dev/Request',
        'requestImageBucketUrl' => 'https://s3-us-west-2.amazonaws.com/doodhan-dev/Request/',
